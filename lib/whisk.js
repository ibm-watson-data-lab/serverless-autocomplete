...
const createAction = function(name, path) {
  ...
  // create package
  var packageParams = ['wsk', 'package', 'update', 'autocomplete'];
  var packageCreate = spawn( 'bx', packageParams);
  ...
  var createParams = ['wsk', 'action', 'update', 'autocomplete/'+name, '--kind', 'nodejs:6', path, '-a', 'web-export', 'true'];
